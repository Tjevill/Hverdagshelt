    ...
    return (
      <div className="Registrer">
        ...
        <div className="form-group">
          ...
          <div className="form-group">
              Kategori:{" "}
              <select name="kategori" onChange={this.handleChange}>
                  <option>Velg kategori</option>
                  <option value="ntnu">NTNU / Trondheim</option>
                  <option value="verden">Nyheter fra verden</option>
                  <option value="bizarro">Merkelige og interessante nyheter</option>
              </select>
          </div>
          <div className="form-group">
          Passord:{" "}
