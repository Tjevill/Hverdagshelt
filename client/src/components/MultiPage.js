...
const MultiPage = ({id}) => (<Page id={id}>
    ...
    <div className="serif">
        ...
        <p className="mt4">
            Two of us are living in a comfortable hotel in the Rue Jacob. It is just back of the Academy of the Beaux Arts and a few minutes’ walk from the Tuileries. Our room costs twelve francs a day for two. It is clean, light, well heated, has hot and cold running water and a bathroom on the same floor. That makes a cost for rent of thirty dollars a month.</p>
