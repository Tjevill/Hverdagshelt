            ...
            <div className="col-md-8">
                <div id="user-edit-page">
                    <div id="main-form" className="col">
                        ...
                        {button}
                        <Button.Success onClick={() => this.save(this.user,this.state)}>Lagre</Button.Success>
                        <button type="button" className="btn btn-info" onClick={() => history.push('/profile/'+this.user.user_id)}>Avbryt</button>
                    </div>
